...
//  进入方向 
let EntryDirectionEnum = {
    Left: 1,
    Right: 2,
};

var UIHandCardBox = ccui.Layout.extend({
    /**
     * cardList 结构:
     * {
    ...
    cardWidth: 50,//
    cardFX: 10,
    entryDirection: EntryDirectionEnum.Right, //默认从右边边进入
    isCover: false,//默认正面
    ...
    ctor: function () {
        ...
        this.showCard = null;
        // this.entryDirection = EntryDirectionEnum.Right;
    ...
    addCard: function (cardData) {
        let cardUrl = "res/Card/Little/sk1002.png";
        if (!(cardData === undefined || cardData == null || cardData.object == undefined)) {
            cardUrl = "res/Card/Little/sk" + cardData.objectId + ".png";
        }
        let hand = new UIHandCard(cardUrl, this.isCover);
        //数据对象处理
        //对象和数据 均放入list
        this.cardList.push({
            card: hand,
    ...
    setCardsHandBoxUI: function (hand) {
        ...
        if (hand !== undefined && (typeof hand === "object")) {
            ...
            if (this.entryDirection == EntryDirectionEnum.Left) {
